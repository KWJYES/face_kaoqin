...
public class ActivityTeacherLoginBindingImpl extends ActivityTeacherLoginBinding  {
    ...
    private androidx.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // svm
            com.viewmodel.svm.activity.teacher.TeacherLoginSVM svm = mSvm;
            // svm.email.getValue()
    ...
    public ActivityTeacherLoginBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ActivityTeacherLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.svm == variableId) {
            setSvm((com.viewmodel.svm.activity.teacher.TeacherLoginSVM) variable);
        }
        else if (BR.click == variableId) {
            setClick((com.view.activity.teacher.TeacherLoginActivity.ClickClass) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSvm(@Nullable com.viewmodel.svm.activity.teacher.TeacherLoginSVM Svm) {
        this.mSvm = Svm;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
    ...
    public void setClick(@Nullable com.view.activity.teacher.TeacherLoginActivity.ClickClass Click) {
        this.mClick = Click;
        synchronized(this) {
            mDirtyFlags |= 0x8L;
        }
    ...
    protected void executeBindings() {
        ...
        java.lang.String svmPasswordGetValue = null;
        androidx.lifecycle.MutableLiveData<java.lang.String> svmEmail = null;
        com.view.activity.teacher.TeacherLoginActivity.ClickClass click = mClick;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.view.activity.teacher.TeacherLoginActivity.ClickClass value;
        public OnClickListenerImpl setValue(com.view.activity.teacher.TeacherLoginActivity.ClickClass value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private com.view.activity.teacher.TeacherLoginActivity.ClickClass value;
        public OnClickListenerImpl1 setValue(com.view.activity.teacher.TeacherLoginActivity.ClickClass value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
