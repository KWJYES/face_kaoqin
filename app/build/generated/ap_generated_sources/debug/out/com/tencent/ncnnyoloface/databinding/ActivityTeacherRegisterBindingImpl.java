...
public class ActivityTeacherRegisterBindingImpl extends ActivityTeacherRegisterBinding  {
    ...
    private androidx.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // svm
            com.viewmodel.svm.activity.teacher.TeacherRegisterSVM svm = mSvm;
            // svm != null
    ...
    public ActivityTeacherRegisterBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private ActivityTeacherRegisterBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.svm == variableId) {
            setSvm((com.viewmodel.svm.activity.teacher.TeacherRegisterSVM) variable);
        }
        else if (BR.click == variableId) {
            setClick((com.view.activity.teacher.TeacherRegisterActivity.ClickClass) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSvm(@Nullable com.viewmodel.svm.activity.teacher.TeacherRegisterSVM Svm) {
        this.mSvm = Svm;
        synchronized(this) {
            mDirtyFlags |= 0x40L;
        }
    ...
    public void setClick(@Nullable com.view.activity.teacher.TeacherRegisterActivity.ClickClass Click) {
        this.mClick = Click;
        synchronized(this) {
            mDirtyFlags |= 0x80L;
        }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MutableLiveData<java.lang.String> svmCaptcha = null;
        androidx.lifecycle.MutableLiveData<java.lang.String> svmUsername = null;
        com.view.activity.teacher.TeacherRegisterActivity.ClickClass click = mClick;
        java.lang.String svmCaptchaGetValue = null;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.view.activity.teacher.TeacherRegisterActivity.ClickClass value;
        public OnClickListenerImpl setValue(com.view.activity.teacher.TeacherRegisterActivity.ClickClass value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private com.view.activity.teacher.TeacherRegisterActivity.ClickClass value;
        public OnClickListenerImpl1 setValue(com.view.activity.teacher.TeacherRegisterActivity.ClickClass value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
