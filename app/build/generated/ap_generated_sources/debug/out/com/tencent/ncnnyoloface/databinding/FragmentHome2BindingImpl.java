...
public class FragmentHome2BindingImpl extends FragmentHome2Binding  {
    ...
    // values
    // listeners
    private OnClickListenerImpl mClickCreateCourseAndroidViewViewOnClickListener;
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.svm == variableId) {
            setSvm((com.viewmodel.svm.fragment.teacher.TeacherHomeSVM) variable);
        }
        else if (BR.click == variableId) {
            setClick((com.view.fragment.teacher.TeacherHomeFragment.ClickClass) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSvm(@Nullable com.viewmodel.svm.fragment.teacher.TeacherHomeSVM Svm) {
        this.mSvm = Svm;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    public void setClick(@Nullable com.view.fragment.teacher.TeacherHomeFragment.ClickClass Click) {
        this.mClick = Click;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
    ...
    protected void executeBindings() {
        ...
        com.viewmodel.svm.fragment.teacher.TeacherHomeSVM svm = mSvm;
        java.lang.String svmUserNameJavaLangString = null;
        android.view.View.OnClickListener clickCreateCourseAndroidViewViewOnClickListener = null;
        ...
        com.view.fragment.teacher.TeacherHomeFragment.ClickClass click = mClick;
        ...
        if ((dirtyFlags & 0xbL) != 0) {
                ...
                // read (svm.userName.getValue()) + (" 老师")
                svmUserNameJavaLangString = (svmUserNameGetValue) + (" 老师");
        }
        if ((dirtyFlags & 0xcL) != 0) {
                ...
                if (click != null) {
                    // read click::createCourse
                    clickCreateCourseAndroidViewViewOnClickListener = (((mClickCreateCourseAndroidViewViewOnClickListener == null) ? (mClickCreateCourseAndroidViewViewOnClickListener = new OnClickListenerImpl()) : mClickCreateCourseAndroidViewViewOnClickListener).setValue(click));
                    // read click::refresh
        ...
        if ((dirtyFlags & 0xcL) != 0) {
            ...
            this.button3.setOnClickListener(clickCreateCourseAndroidViewViewOnClickListener);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.view.fragment.teacher.TeacherHomeFragment.ClickClass value;
        public OnClickListenerImpl setValue(com.view.fragment.teacher.TeacherHomeFragment.ClickClass value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
        public void onClick(android.view.View arg0) {
            this.value.createCourse(arg0); 
        }
    }
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private com.view.fragment.teacher.TeacherHomeFragment.ClickClass value;
        public OnClickListenerImpl1 setValue(com.view.fragment.teacher.TeacherHomeFragment.ClickClass value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
